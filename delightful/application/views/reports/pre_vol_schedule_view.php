...
foreach ($events as $event){
   echoT('<font style="font-size: 12pt;"><b><u>'.htmlspecialchars($event->strEventName).'</u></b></font>&nbsp;'
             .strLinkView_VolEvent($event->lKeyID, 'View event', true).'<br>');

   echoT('<table>');
   foreach ($event->dates as $oneDate){
      echoT('
               <tr>
                  <td colspan="5" style="font-size: 12pt;font-variant:small-caps;">'
